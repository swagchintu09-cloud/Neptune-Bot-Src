...
module.exports = async (client, guild) => {
  client.on("guildCreate", async (guild) => {
    ...
    let mb = new EmbedBuilder()
      ...
      .setDescription(
        `<:arrow:1447651730681761824> I come up with default prefix as : \`${client.config.prefix}\`\n<:arrow:1447651730681761824> I am a High Quality Rythmic music bot with lots of unique features\n<:arrow:1447651730681761824> I come up with different search engines, You may try out me with \`play\`\n<:arrow:1447651730681761824> If you find any bug or want any kind of help regarding our services of Argo Bot\n<:arrow:1447651730681761824> Please consider Joining [Support server](${client.config.ssLink}) by clicking [here](${client.config.ssLink})`
      )
