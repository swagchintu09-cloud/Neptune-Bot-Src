      ...
      if (interaction.customId === "setup_pause") {
        if (await check(interaction, player)) {
              ...
              .addOptions(
                {
                  ...
                  value: "bassboost",
                  emoji: "<:filterplayer:1447944465519218760>",
                },
                {
                  label: "Nightcore",
                ...
                },
                {
                  ...
                  value: "none",
                  emoji: "<:Reset:1447944729504382977>",
                }
              )
          );
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Player is ${state} by ${interaction.user.username}`,
            })
            .then((msg) => {
              setTimeout(async () => {
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Replaying the current track.`,
            })
            .then((msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Skipped the track. Action by: ${interaction.user.username}`,
            })
            .then((msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Player has been shuffled by: ${interaction.user.username}`,
            })
            .then(async (msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Player has been stopped by: ${interaction.user.username}`,
            })
            .then((msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Queue has been cleared by: ${interaction.user.username}`,
            })
            .then((msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
        ...
        if (await check(interaction, player)) {
          ...
          return await interaction.channel
            .send({
              content: `<:sec_tick:1447943806631809196> | Volume has been changed by: ${interaction.user.username}`,
            })
            .then((msg) => {
              setTimeout(async () => {
                await msg.delete().catch(() => {});
      ...
      if (interaction.customId === "filterSelect") {
        if (await check(interaction, player)) {
          ...
          const embed = new EmbedBuilder()
            .setDescription(`<:sec_tick:1447943806631809196> | **Filter applied:** \`${selectedFilter}\``)
      ...
      if (interaction.isButton() || interaction.isStringSelectMenu()) {
        if (!interaction.member.voice.channel) {
          await interaction.reply({
            content: `<:Crossmark:1447578705198055484> | You must be sitting in a voice channel.`,
            ephemeral: true,
          });
          return false;
        }
        ...
        if (
          ...
          await interaction.reply({
            content: `<:Crossmark:1447578705198055484> | You must be in the same voice channel.`,
            ephemeral: true,
          });
          return false;
        }
        ...
        if (!player) {
          await interaction.reply({
            content: `<:Crossmark:1447578705198055484> | Player doesn't exist currently.`,
            ephemeral: true,
          });
          return false;
        }
