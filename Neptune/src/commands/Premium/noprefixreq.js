    ...
    run: async (client, message, args, prefix) => {
        try {
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: "1. Boost Support Server", value: "- You can get NoPrefix by Boosting our [Support Server!](https://discord.gg/RbyBv2GsTn)" },
                    { name: "2. Add Crystal in more than 5 Guilds", value: "- Add Crystal in more than 5 Guilds with More than 1000+ Members in each server" },
                    { name: "3. Buying NoPrefix", value: "- You can buy NoPrefix at Only 50rs. for Crystal" }
                )
