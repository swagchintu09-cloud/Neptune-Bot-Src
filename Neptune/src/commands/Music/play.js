  ...
  run: async (client, message, args, prefix, track) => {
    ...
    if (!check) {
      if (
        ...
        return message.reply(
          `<:Crossmark:1447578705198055484> | I don't have permission to join your voice channel!`
        );
      ...
      if (
        ...
        return message.reply(
          `<:Crossmark:1447578705198055484> | I don't have permission to view your voice channel!`
        );
      ...
      if (
        ...
        return message.reply(
          `<:Crossmark:1447578705198055484> | I don't have permission to speak in your voice channel!`
        );
    }
    ...
    if (!result.tracks.length) {
      const embed = new EmbedBuilder()
        .setDescription("<:Crossmark:1447578705198055484> | No results found!")
        .setColor(client.color);
    ...
    if (result.type === "PLAYLIST") {
      const embed = new EmbedBuilder()
        .setDescription(
          `<:NeXPlaylist:1447642539485167646>  | **Queued** ${result.tracks.length} **from [${result.playlistName}](${client.config.ssLink})**`
        )
        .setColor(client.color);
      ...
      const embed = new EmbedBuilder()
        .setColor(client.color)
        .setDescription(
          `<:NeXPlaylist:1447642539485167646>  | **Queued [${
