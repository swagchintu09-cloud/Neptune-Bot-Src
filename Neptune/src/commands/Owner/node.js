...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    let dakshh = ['354455090888835073'];
      if (!dakshh.includes(message.author.id)) return message.reply({content : `<:Crossmark:1447578705198055484> | Be my owner to run this command.`})
