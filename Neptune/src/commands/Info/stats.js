...
if (client.shard && client.shard.count > 1) {
    ...
    botGuilds = client.guilds.cache.size;
        ...
        const embed3 = createEmbed([ 
            { name: "**__Developers__**", value: `**1.** [Rudra </>](https://discord.com/users/354455090888835073) [ID: 354455090888835073]` },
            { name: "**__Owners__**", value: `**1.** [Rudra </>](https://discord.com/users/876822243492102185) [ID: 876822243492102185]\n**2.** [Rudra </>](https://discord.com/users/354455090888835073) [ID: 354455090888835073]` },
        ], "Team Information");
