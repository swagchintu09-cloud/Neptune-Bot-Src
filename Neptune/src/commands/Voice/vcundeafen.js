...
module.exports = {
  name: "vcundeafen",
  category: "Voice",
  description: "Undeafen a user in VC",
    ...
    try {
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            .setColor("#202225")
            .setDescription(`<:TICK:1447578703335919778> | ${target} has been undeafened.`),
        ],
      });
    } catch {
      return message.reply({
        embeds: [
          new EmbedBuilder()
            .setColor("#202225")
            .setDescription("<:Crossmark:1447578705198055484> | Failed to undeafen user."),
        ],
      });
    }
  },
